...
CREATE TABLE "Pedido" (
    ...
    "texto" TEXT NOT NULL,
    "todoMundo" BOOLEAN NOT NULL DEFAULT false,
    "criadorId" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Pedido_criadorId_fkey" FOREIGN KEY ("criadorId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_Tarefa" ("assigneeId", "clienteId", "createdAt", "criadorId", "descricao", "estimativaMin", "id", "prazo", "projetoId", "status", "titulo", "updatedAt") SELECT "assigneeId", "clienteId", "createdAt", "criadorId", "descricao", "estimativaMin", "id", "prazo", "projetoId", "status", "titulo", "updatedAt" FROM "Tarefa";
DROP TABLE "Tarefa";
